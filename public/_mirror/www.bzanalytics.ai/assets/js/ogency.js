(function ($) {
  ...
  //           // Redirect to a different URL after a successful submission
  //           window.location.href = 'contact'; // Replace with the URL you want to redirect to
  //         }
  //       );
  //       return true;
  //     },
  ...
  // if ($(".consult-form-validated").length) {
  //   $(".consult-form-validated").validate({
  //     // initialize the plugin
  //     rules: {
  //       firstname: {
  //         required: true,
  ...
  //           $(form).find("textarea").val("");
  //           // Redirect to a different URL after a successful submission
  //           window.location.href = 'consult'; // Replace with the URL you want to redirect to
  //         }
  //       );
  //       return true;
  //     },
