...
export const portfolioData: Record<string, PortfolioItem> = {
  ...
  "bznftmart-decentralized-nft-marketplace": {
    id: "02",
    title: "Promoting Decentralization: BzNFTMart",
    ...
    sections: [
      {
        heading: "BzNFTMart Architecture",
        content:
      ...
      {
        heading: "Key Features of BzNFTMart",
        content:
          "BzNFTMart offers several key features: a User-Friendly Interface, Secure Transactions via Solidity, Instant Bidding and Trading via Node.js real-time communication, and Community Features including user profiles, social sharing, and comments. It supports Algorand P2P Marketplace mechanics with high throughput and low gas fees.",
      },
      {
        heading: "Benefits of BzNFTMart",
        content:
    ...
    conclusion:
      "Take the plunge into the world of decentralized gaming today! Connect with us to become a valued member of BzNFTMart and access a secure and easy-to-use platform. Android and iOS applications are also available.",
  ...
  "learning-with-minecraft": {
    ...
    sections: [
      ...
      {
        heading:
          "Customized Game Modes: Tailored to Specific Educational Objectives",
        content:
  ...
  "virtual-hub": {
    ...
    sections: [
      ...
      {
        heading:
          "Multiplayer Functionality - Real-time Interaction with Other Users",
        content:
  ...
  "augmented-reality": {
    ...
    sections: [
      {
        heading:
          "Augmented Reality and Voice Recognition — The Best of Both Worlds",
        content:
      ...
      {
        heading:
          "Improving Accuracy with Audio-Visual Speech Recognition (AVSR)",
        content:
...
export const industries: Industry[] = [
  {
    ...
    subtitle: "METAVERSE AND GAMING PROJECTS SHOWCASE",
    description:
      "Explore our metaverse and gaming projects with immersive AR/VR experiences, blockchain-based marketplaces, and gamified learning ecosystems.",
